...
<section>
    <div class="container card-profil py-2 mt-2 rounded">
        <div class="d-flex mt-3 p-3 bg-white rounded ">
            ...
            <img src="<?php echo isset($_SESSION['image']) && !empty($_SESSION['imag']) ? $_SESSION['image'] : '../image/icone-user.gif'; ?>" alt="Image icone" height="90px" class="rounded-start-circle rounded-end-circle">
        </div>
